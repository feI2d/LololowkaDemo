...
import com.storyteam.custom.items.interworld.TypeMask;
...
public class CustomItemsManager {
    ...
    // Фиалы жизненной силы
    public static Item FULL_VIAL;
    public static Item SUB_MEDIUM_VIAL;
    public static Item MEDIUM_VIAL;
    ...
    public static void init() {
        ...
        FULL_VIAL = register(new Vial(VialType.FULL), "full_vial");
        SUB_MEDIUM_VIAL = register(new Vial(VialType.SUB_MEDIUM), "sub_medium_vial");
